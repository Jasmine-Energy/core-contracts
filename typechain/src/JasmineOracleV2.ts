...
export interface JasmineOracleV2Interface extends utils.Interface {
  functions: {
    "acceptOwnership()": FunctionFragment;
    "getCertificateType(uint256)": FunctionFragment;
    "getEndorsement(uint256)": FunctionFragment;
    "getFuelType(uint256)": FunctionFragment;
    "getLocationData(uint256)": FunctionFragment;
    "getRegistry(uint256)": FunctionFragment;
    "getUUID(uint256)": FunctionFragment;
    "getVintage(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getCertificateType",
  ...
  encodeFunctionData(
    functionFragment: "getFuelType",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "getLocationData",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "getVintage", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "hasCertificateType",
    data: BytesLike
  ): Result;
...
export interface JasmineOracleV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: JasmineOracleV2Interface;
  ...
  functions: {
    ...
    getRegistry(
      id: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { registry: BigNumber }>;
    ...
    getVintage(
      id: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { vintage: BigNumber }>;
